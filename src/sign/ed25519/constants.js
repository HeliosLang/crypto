...
// The largest prime number that is <= the number of unique points on the curve
...
//    -x^2 + y^2 = 1 - d*x^2*y^2
// Note: the negative number is already included in the parameter
export const D =
...
// Generator point
export const Gx =
    15112221349535400772501151409588531511454012693041857206046113283949847762202n // recoverX(B[1]) % P
export const Gy =
